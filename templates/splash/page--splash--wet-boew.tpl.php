    ...
    <div class="container">
      <div class="row mrgn-tp-lg mrgn-bttm-lg">
        <section class="col-md-8 col-md-offset-2">
          <object type="image/svg+xml" tabindex="-1" role="img" data="/profiles/wetkit/libraries/wet-boew/assets/logo.svg" aria-label="<?php print t('Web Experience Toolkit'); ?>"></object>
        </section>
      </div>
    </div>
  </div>
  ...
  <div class="row mrgn-tp-lg">
    <div class="col-md-12">
      ...
      <section class="col-md-6" lang="fr">
        ...
        <a class="btn btn-lg btn-primary btn-block" href="<?php print '/' . $language_prefix_alt; ?>"><?php print t('Francais'); ?></a>
