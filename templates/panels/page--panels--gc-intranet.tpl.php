  ...
  <div id="wb-bnr">
    ...
    <div class="<?php print $container_class; ?>">
      <div class="row">
        ...
        <object id="wmms" type="image/svg+xml" tabindex="-1" role="img" data="/profiles/wetkit/libraries/theme-gc-intranet/assets/wmms-intra.svg" aria-label="<?php print t('Symbol of the Government of Canada'); ?>"></object>
